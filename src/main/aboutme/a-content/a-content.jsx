    ...
    <div className="a-container">
      <div className="a-para-card">
        ...
        <div className="msg-flex">
            <h3 className="title a-para-content">I am a proficient MERN stack and Java developer 
            </h3>
        ...
        <div className="msg-flex">
          <p className="a-para-content">
            ...
            MongoDB, Express.js, React.js, Node.js, MySQL and Springboot to craft visually
...
<br />
        <div className="msg-send">
         <input type="text" placeholder="Congratulations, you're in!" className="input"></input>
